 ...
 *
 * The project used to rely on a Replit-provisioned database. Locally we run a
 * self-contained PostgreSQL instance that lives entirely inside this repo
 * (data directory: lib/db/.pgdata) so it never touches any other project or
 * any system-wide Postgres installation.
 *
